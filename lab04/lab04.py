...
def distance(city_a, city_b):
    ...
    5.0
    """
    a_lon, a_lat = get_lon(city_a), get_lat(city_a)
    b_lon, b_lat = get_lon(city_b), get_lat(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    given_city = make_city('my_city', lat, lon)
    from_city_a = distance(given_city, city_a)
    from_city_b = distance(given_city, city_b)
    if from_city_a < from_city_b:
